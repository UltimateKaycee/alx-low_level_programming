...
/**
 * get_digit - function to convert a digit character
 * to a corresponding int.
 * @chtr: character to be converted.
 * Description: If chtr is a non-digit, the function
 * exits with a status of 98.
 * Return: The converted int.
 */
int get_digit(char chtr)
{
	int digit = chtr - '0';
...
/**
 * get_prod - function to multiply a string of
